# ShipShape — Codex Rules

## Git Commit Rules

- **Never** add "Co-Authored-By", "by Codex", or any AI attribution to commit messages. Commits should look like they were written by the developer, with no AI co-author tags.
